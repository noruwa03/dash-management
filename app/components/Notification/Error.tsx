...
const Error = (props: IError) => {
  return (
    <div className="z-50 fixed lg:top-20 top-20 left-[50%] -translate-x-[50%]">
      <div className="mx-2 lg:w-[23rem] w-[17rem] flex flex-row items-center justify-center bg-[#FEE5E5] border-[1px] border-[#D14343] lg:p-5 p-3 text-sm leading-none rounded-lg">
